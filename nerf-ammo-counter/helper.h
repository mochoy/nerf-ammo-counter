...
//
//when you change the value, the "currentMagSize"(several lines below) has to be less than the muber of different magazines, 
...
//starting from 0. Ex: byte array = {1(0), 2(1), 3(2), 4(3)} - the numbers without parenthesis are the values this array/list 
